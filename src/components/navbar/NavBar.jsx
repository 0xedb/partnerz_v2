...
function NavBar() {
  ...
  return (
    <nav className={nav}>
      <div className={`${nav_content} ${centered}`}>
        <div className={`${nav_menu} ${nav_item} ${centered}`}>
          <img
        ...
        <div className={`${nav_item} ${centered}`}>
          <Link to="/#" className={`${nav_item} ${centered}`}>
            <img
              src={partnerz_logo}
        ...
        <div className={`${nav_item} ${centered}`}>
          <Link to="/form" className={`${nav_item} ${centered}`}>
            <img
